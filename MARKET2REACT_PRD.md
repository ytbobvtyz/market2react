...
[TODO]Реализовать регистрацию по коду на эл. почту
[TODO]Реализовать рассылку сообщений на почту по достижении товаром целевой цены
[TODO]Арендовать домен для проекта и вылжожить его на сервер.
[TODO]Добавить монетизацию - свыше двух отслижваний - платно
[TODO]Подтянуть все элементы под единый стиль
